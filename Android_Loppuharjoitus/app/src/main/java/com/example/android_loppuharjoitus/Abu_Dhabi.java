...
public class Abu_Dhabi extends AppCompatActivity {

    private String mUrl = "https://api.open-meteo.com/v1/forecast?latitude=24.4764&longitude=54.3705&current_weather=true&windspeed_unit=ms&timezone=auto";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_abu_dhabi);
